                ...
                <form action="${pageContext.request.contextPath }/student/exam" method="post" id="formExam">
                    ...
                    <%-- <input type="hidden" name="questions[${indexQuestion }].question_id" value="${question.id }" /> --%>
                        <div class="card">
                            <div id="10" class="card-header bg-white">
                                <div class="media align-items-center">
                                    <div class="media-left">
                                        <h4 class="mb-0"><strong>Câu ${loop.index+1 }</strong></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <core:forEach var="answer" items="${question.answers }">
                                    <div class="form-group">
                                        <core:choose>
                                            <core:when test="${question.answerType==1}">
                                                <label class="custom-control custom-checkbox mb-0">
                                                    <input type="checkbox" class="custom-control-input" name="questions_${question.id }" value="${answer.id}">
                                            ...
                                            <core:when test="${question.answerType==2}">
                                                <label class="custom-control custom-radio mb-0">
                                                    <input type="radio" class="custom-control-input" name="questions_${question.id }" value="${answer.id}">
                                                    <span class="custom-control-indicator"></span>
                                                    <span class="custom-control-description">
                                                        <core:out value="${ answer.content}" escapeXml="false"></core:out>
                                                    </span>
                        ...
                        <core:set var="indexQuestion" value="${indexQuestion+1 }" />
                    </core:forEach>
                    <!-- End Body exam -->
                </form>
            </div>
            ...
            <div class="mdk-drawer__content">
                <div class="sidebar sidebar-right sidebar-light bg-white o-hidden">
                    <div class="sidebar-p-y" data-simplebar data-simplebar-force-enabled="true">
                        ...
                        <div class="countdown sidebar-p-x" data-value="0.01" data-unit="hour"></div>
