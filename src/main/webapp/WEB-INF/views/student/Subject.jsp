        ...
        <div class="mdk-drawer-layout__content mdk-drawer-layout__content--scrollable">
            <div class="container-fluid">
                ...
                <div id="filter-wrapper">
                    ...
                    <div class="row">
                        <core:forEach var="subject"
                                      items="${subjects }">
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-header bg-white text-center">
                                        <h4 class="card-title">
                                            <a href="student-take-course.html">${subject.name }</a>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <span class="badge badge-primary ">GULP</span>
                                        <span class="badge badge-primary ">SLUSH</span>
                                        <br>
                                        <span class="text-justify float-right">Let’s start with a quick tour of Vue’s data binding features. If you are more interested in ...</span>
                                        <a href="#"
                                           class="text-right">Detail</a>
                                        <br>
                                        <button type="button"
                ...
                <core:forEach var="item" items="${levels }">
                    <div class="form-group">
                        <a type="button" class="btn ${item.color } btn-select-level"
                           href="${pageContext.request.contextPath }/student/exam?level_id=${item.id }&subject_id=">${item.name }</a>
                    </div>
                </core:forEach>
            </div>
        </div>
