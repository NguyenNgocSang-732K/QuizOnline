...
<template:_admin title="ManageQuestion">
 ...
 <link rel="stylesheet"
       href="${pageContext.request.contextPath}/resources/admin/account/manageQuestion.css">
        ...
        <div id="filter-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-3">
                        <input name="search" class="form-control" placeholder="Search by Content, Level"
                               size="4"/>
                    </div>
                    <div class="col-1">
                ...
                <div class="row">
                    <div class="col">
                        <table class="table">
                            ...
                            <core:forEach items="${questionModels.data}" var="question" varStatus="i">
                                           ...
                                           <td>
                                               <div class="mdc-switch mdc-switch--checked">
                                                   ...
                                                   <div class="mdc-switch__thumb-underlay">
                                                       ...
                                                       <input type="checkbox" id="another-basic-switch"
        ...
        <script>
            var data = [[${questionModels.totalPages}]]
        </script>
	</jsp:attribute>
</template:_admin>